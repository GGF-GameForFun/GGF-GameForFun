...
export const TRANSLATIONS: Record<Locale, Dict> = {
  en: {
    ...
    "tunnel.diagnostics": "Tunnel diagnostics",
    "tunnel.diagAgent": "playit.gg agent running",
    "tunnel.diagClaimNeeded": "Claim required",
    "tunnel.diagClaimReady": "Claim ready",
    "tunnel.diagAddressFound": "Public address found",
    "tunnel.diagAddressMissing": "Waiting for public address",
    "tunnel.diagServerRunning": "Minecraft server running",
    "tunnel.diagServerNotRunning": "Minecraft server not running",
    "tunnel.diagLocalPort": "Local port: {port}",
    ...
    "mods.deleteAll": "Delete All",
    "mods.deleteAllConfirmTitle": "Delete all {count} mods?",
    "mods.deleteAllConfirmBody": "Every .jar file in your mods folder will be permanently deleted. This cannot be undone.",
    "mods.deleteAllRunning": "Deleting…",
    "mods.deleteAllSuccess": "✓ Removed {count} mods",
    "mods.importing": "Importing mods… {current} / {total}",
    "mods.importSuccess": "✓ Imported {count} mods",
    ...
    "settings.updateSection": "App Updates",
    "settings.updateDesc": "Check GitHub Releases for the latest GameForFun installer.",
    ...
    "settings.remoteNoToken": "No token generated yet",
    "settings.remoteGenerate": "Generate",
    "settings.remoteCopyUrl": "Copy URL",
    "settings.remoteRestart": "Restart service",
    "settings.remoteRunning": "Remote service running",
    "settings.remoteStopped": "Remote service stopped",
    "settings.remoteSaveHint": "Save settings to apply remote control changes.",
    "settings.remotePublicUrl": "Public tunnel URL",
    "settings.remotePublicUrlDesc": "For access from another Wi-Fi/network, use the free Cloudflare quick tunnel below, or paste another HTTPS tunnel URL that forwards to local port {port}.",
    "settings.remoteCreateTunnel": "Create tunnel",
    "settings.remoteLanUrl": "LAN URL",
    "settings.cloudflareRemote": "Free public remote via Cloudflare",
    "settings.cloudflareRemoteDesc": "Starts cloudflared quick tunnel for this remote dashboard. The public trycloudflare.com URL changes when restarted.",
    "settings.cloudflareStart": "Start free public remote",
    "settings.cloudflareStarting": "Starting…",
    "settings.cloudflareStop": "Stop public remote",
    "settings.cloudflareNoUrl": "Cloudflare started, but the public URL is not ready yet. Wait a few seconds and try again.",
    "settings.lanRemoteTitle": "LAN Remote",
    "settings.lanRemoteDesc": "Access GameForFun from another device on your home Wi-Fi using the local URL below.",
    "settings.lanRemoteIpLabel": "Local network URL",
    "settings.lanRemoteEnableHint": "Toggle on to start the LAN service.",
    "settings.cloudflareTitle": "Cloudflare Public",
    "settings.cloudflareDesc": "Free public access from anywhere via Cloudflare quick tunnel — no router config needed. The URL changes each restart.",
    "settings.cloudflareIpLabel": "Public URL",
    "settings.cloudflareIdle": "Toggle on to create a public URL.",
    "settings.cloudflareLanRequired": "Enable LAN Remote first — Cloudflare tunnels to the LAN service.",
    "settings.remotePublicUrlAdvanced": "Advanced: paste your own tunnel URL",
    ...
    "close.title": "Background services are still running",
    "close.body": "GameForFun is still managing active services. Confirm to stop them cleanly before the app closes.",
    "close.runningItems": "Running now",
    "close.itemServer": "Minecraft server",
    "close.itemPlayit": "playit.gg tunnel",
    "close.itemCloudflare": "Cloudflare public remote",
    "close.itemRemote": "Remote control service",
    "close.stopAndQuit": "Stop everything & quit",
    "close.stopping": "Stopping everything…",
  ...
  vi: {
    ...
    "tunnel.diagnostics": "Chẩn đoán tunnel",
    "tunnel.diagAgent": "Agent playit.gg đang chạy",
    "tunnel.diagClaimNeeded": "Cần claim tunnel",
    "tunnel.diagClaimReady": "Claim đã sẵn sàng",
    "tunnel.diagAddressFound": "Đã có địa chỉ public",
    "tunnel.diagAddressMissing": "Đang chờ địa chỉ public",
    "tunnel.diagServerRunning": "Minecraft server đang chạy",
    "tunnel.diagServerNotRunning": "Minecraft server chưa chạy",
    "tunnel.diagLocalPort": "Port local: {port}",
    ...
    "mods.deleteAll": "Xóa Tất Cả",
    "mods.deleteAllConfirmTitle": "Xóa toàn bộ {count} mod?",
    "mods.deleteAllConfirmBody": "Tất cả file .jar trong thư mục mods sẽ bị xóa vĩnh viễn. Không thể hoàn tác.",
    "mods.deleteAllRunning": "Đang xóa…",
    "mods.deleteAllSuccess": "✓ Đã xóa {count} mod",
    "mods.importing": "Đang import mod… {current} / {total}",
    "mods.importSuccess": "✓ Đã import {count} mod",
    ...
    "settings.updateSection": "Cập Nhật App",
    "settings.updateDesc": "Kiểm tra GitHub Releases để lấy installer GameForFun mới nhất.",
    ...
    "settings.remotePort": "Port",
    "settings.remoteToken": "Token truy cập",
    "settings.remoteNoToken": "Chưa tạo token",
    "settings.remoteGenerate": "Tạo token",
    "settings.remoteCopyUrl": "Chép URL",
    "settings.remoteRestart": "Khởi động lại dịch vụ",
    "settings.remoteRunning": "Dịch vụ remote đang chạy",
    "settings.remoteStopped": "Dịch vụ remote đang tắt",
    "settings.remoteSaveHint": "Lưu cài đặt để áp dụng thay đổi remote control.",
    "settings.remotePublicUrl": "URL tunnel public",
    "settings.remotePublicUrlDesc": "Để truy cập từ Wi-Fi/mạng khác, dùng Cloudflare quick tunnel miễn phí bên dưới, hoặc dán URL HTTPS tunnel khác trỏ tới port local {port}.",
    "settings.remoteCreateTunnel": "Tạo tunnel",
    "settings.remoteLanUrl": "URL LAN",
    "settings.cloudflareRemote": "Remote public miễn phí qua Cloudflare",
    "settings.cloudflareRemoteDesc": "Chạy cloudflared quick tunnel cho dashboard remote này. URL public trycloudflare.com sẽ đổi khi khởi động lại.",
    "settings.cloudflareStart": "Bật remote public miễn phí",
    "settings.cloudflareStarting": "Đang bật…",
    "settings.cloudflareStop": "Tắt remote public",
    "settings.cloudflareNoUrl": "Cloudflare đã bật nhưng URL public chưa sẵn sàng. Chờ vài giây rồi thử lại.",
    "settings.lanRemoteTitle": "LAN Remote",
    "settings.lanRemoteDesc": "Truy cập GameForFun từ thiết bị khác trong mạng Wi-Fi nhà bạn qua URL local bên dưới.",
    "settings.lanRemoteIpLabel": "URL trong mạng nội bộ",
    "settings.lanRemoteEnableHint": "Bật để khởi động dịch vụ LAN.",
    "settings.cloudflareTitle": "Cloudflare Public",
    "settings.cloudflareDesc": "Truy cập public từ mọi nơi qua Cloudflare quick tunnel — không cần cấu hình router. URL sẽ đổi mỗi lần khởi động lại.",
    "settings.cloudflareIpLabel": "URL Public",
    "settings.cloudflareIdle": "Bật để tạo URL public.",
    "settings.cloudflareLanRequired": "Bật LAN Remote trước — Cloudflare tunnel sẽ trỏ tới dịch vụ LAN.",
    "settings.remotePublicUrlAdvanced": "Nâng cao: dán URL tunnel của bạn",
    ...
    "close.title": "Dịch vụ nền vẫn đang chạy",
    "close.body": "GameForFun vẫn đang quản lý các dịch vụ đang hoạt động. Xác nhận để dừng sạch trước khi đóng app.",
    "close.runningItems": "Đang chạy",
    "close.itemServer": "Server Minecraft",
    "close.itemPlayit": "Tunnel playit.gg",
    "close.itemCloudflare": "Remote public Cloudflare",
    "close.itemRemote": "Dịch vụ remote control",
    "close.stopAndQuit": "Dừng tất cả & thoát",
    "close.stopping": "Đang dừng tất cả…",
