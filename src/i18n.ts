...
export const TRANSLATIONS: Record<Locale, Dict> = {
  en: {
    ...
    "update.currentVersion": "You're on v{v}. Click below to view the new release.",
  ...
  vi: {
    ...
    "update.currentVersion": "Bạn đang dùng v{v}. Bấm bên dưới để xem bản mới.",
    "update.viewRelease": "Xem bản mới",
